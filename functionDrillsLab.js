...
//CODE HERE
function logHelloWorld(name) {
  console.log(name)
}
logHelloWorld('Hello, World!')
...
let updatedContestants = theEliminator(contestants)
...
let emailName = emailCheck('stuckityl@gmail.com')
...
function frogEater2(gold) {
  ...
  let totalFrogs2 = frogEater2(550)
